	...
	return (
		<div className="pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
			<div className="bg-gray-900 pb-20 sm:pb-24 xl:pb-0">
				<div className="mx-auto flex max-w-screen-2xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
					<div className="-mt-8 w-full max-w-sm xl:-mb-8 xl:w-96 xl:flex-none">
